    ...
    function Scroller(elem, settings) {
        ...
        function generateWheelItems(i) {
            ...
            for (j in warr[i]) {
                ...
                html += '<div class="dw-li dw-v" data-val="' + j + '" style="height:' + hi*2 + 'px;line-height:' + hi*2 + 'px;"><div class="dw-i">' + warr[i][j] + '</div></div>';
                l++;
            }
            html += '</div>';
            return html;

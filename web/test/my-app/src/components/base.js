function getUrl() {
    var _getHost = window.location.protocol+ '//' + window.location.host + (window.location.hostname==='localhost' ? '' : '/code/test/bqjr/build/json'),
        _baseUrl = _getHost;
    return {
        ...
        getMyFlowList : _baseUrl+'/myFlowList.json'                                   //我的流程列表(我发起的/待我审批/我已审批)
    }
}
var base = {
    getUrl : getUrl()

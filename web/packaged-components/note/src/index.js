...
(function (util, store) {
  ...
  function Note(options) {
    ...
    note.id = options.id || 'm-note-' + count;
  ...
  document.addEventListener('DOMContentLoaded', function (e) {
    ...
    $('#create').addEventListener('click', function (e) {
      var note = new Note({
        left: 40+20*count > (window.innerWidth - 220 - 40) ? (window.innerWidth - 220 - 60) : 60+20*count,
        top: 40+20*count > (window.innerHeight - 320 - 40) ? (window.innerHeight - 320 - 40) : 40+20*count,
        zIndex: maxZIndex++
      });
      note.save();
	  count++;
